...
- Results shown here are for a single Reynolds number, however the solver could be swept across Reynolds numbers and angle of attack to build up a proper L/D dataset for different conditions. 
